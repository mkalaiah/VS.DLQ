...
@Injectable()
export class QueryServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfQueryDto> {
        let url_ = this.baseUrl + "/api/services/app/Query/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfQueryDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfQueryDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfQueryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfQueryDto.fromJS(resultData200) : new ListResultDtoOfQueryDto();
            return Observable.of(result200);
            });
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<ListResultDtoOfQueryDto>(<any>null);
    }
}

@Injectable()
export class ReportIllegalActivityServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfRuleDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfRuleDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfRuleDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfRuleDto.fromJS(resultData200) : new ListResultDtoOfRuleDto();
            return Observable.of(result200);
            });
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<ListResultDtoOfRuleDto>(<any>null);
    }
}
...
@Injectable()
export class SpeciesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfSpeciesDto> {
        let url_ = this.baseUrl + "/api/services/app/Species/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfSpeciesDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfSpeciesDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfSpeciesDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfSpeciesDto.fromJS(resultData200) : new ListResultDtoOfSpeciesDto();
            return Observable.of(result200);
            });
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<ListResultDtoOfSpeciesDto>(<any>null);
    }
}
...
export class CreateQueryDto implements ICreateQueryDto {
    ...
    responseTimeStamp: moment.Moment | undefined;

    constructor(data?: ICreateQueryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.responseTimeStamp = data["responseTimeStamp"] ? moment(data["responseTimeStamp"].toString()) : <any>undefined;
        }
    }

    static fromJS(data: any): CreateQueryDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateQueryDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["responseTimeStamp"] = this.responseTimeStamp ? this.responseTimeStamp.toISOString() : <any>undefined;
        return data; 
    }

    clone(): CreateQueryDto {
        const json = this.toJSON();
        let result = new CreateQueryDto();
        result.init(json);
        return result;
...
export class ListResultDtoOfQueryDto implements IListResultDtoOfQueryDto {
    items: QueryDto[] | undefined;

    constructor(data?: IListResultDtoOfQueryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfQueryDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfQueryDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfQueryDto {
    items: QueryDto[] | undefined;
}
...
export class CreateReportIllegalActivityDto implements ICreateReportIllegalActivityDto {
    userId: number | undefined;
    userName: string;
    vesselNo: string;
    illegalActivityDate: moment.Moment | undefined;
    description: string | undefined;
    timeStamp: moment.Moment | undefined;

    constructor(data?: ICreateReportIllegalActivityDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.illegalActivityDate = data["illegalActivityDate"] ? moment(data["illegalActivityDate"].toString()) : <any>undefined;
            this.description = data["description"];
            this.timeStamp = data["timeStamp"] ? moment(data["timeStamp"].toString()) : <any>undefined;
        }
    }

    static fromJS(data: any): CreateReportIllegalActivityDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateReportIllegalActivityDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["illegalActivityDate"] = this.illegalActivityDate ? this.illegalActivityDate.toISOString() : <any>undefined;
        data["description"] = this.description;
        data["timeStamp"] = this.timeStamp ? this.timeStamp.toISOString() : <any>undefined;
        return data; 
    }

    clone(): CreateReportIllegalActivityDto {
        const json = this.toJSON();
        let result = new CreateReportIllegalActivityDto();
        result.init(json);
        return result;
...
export interface ICreateReportIllegalActivityDto {
    userId: number | undefined;
    userName: string;
    vesselNo: string;
    illegalActivityDate: moment.Moment | undefined;
...
export class CreateReportIssueDto implements ICreateReportIssueDto {
    userId: number | undefined;
    userName: string;
    issueDescription: string;
    timeStamp: moment.Moment | undefined;

    constructor(data?: ICreateReportIssueDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateReportIssueDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateReportIssueDto();
        result.init(data);
        return result;
    }
...
export interface ICreateReportIssueDto {
    userId: number | undefined;
    userName: string;
    issueDescription: string;
    timeStamp: moment.Moment | undefined;
...
export class ListResultDtoOfRuleDto implements IListResultDtoOfRuleDto {
    items: RuleDto[] | undefined;

    constructor(data?: IListResultDtoOfRuleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfRuleDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfRuleDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfRuleDto {
    items: RuleDto[] | undefined;
}
...
export class ListResultDtoOfSpeciesDto implements IListResultDtoOfSpeciesDto {
    items: SpeciesDto[] | undefined;

    constructor(data?: IListResultDtoOfSpeciesDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(SpeciesDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfSpeciesDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfSpeciesDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfSpeciesDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfSpeciesDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfSpeciesDto {
    items: SpeciesDto[] | undefined;
}
