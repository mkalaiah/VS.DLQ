 ...
 * @return Success
 */
    submit(input: QuestionInput | null | undefined): Observable<QuestionOutput> {
        ...
        return this.http.request("post", url_, options_).flatMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<QuestionOutput>><any>Observable.throw(response_);
        });
    }
    ...
    protected processSubmit(response: HttpResponseBase): Observable<QuestionOutput> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).flatMap(_responseText => {
                ...
                result200 = resultData200 ? QuestionOutput.fromJS(resultData200) : new QuestionOutput();
        ...
        return Observable.of<QuestionOutput>(<any>null);
    }
}
...
export class QuestionInput implements IQuestionInput {
    userId: number;
    userName: string;
    emailAddress: string;
    question: string;

    constructor(data?: IQuestionInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuestionInput {
        data = typeof data === 'object' ? data : {};
        let result = new QuestionInput();
        result.init(data);
        return result;
    }
...
export class QuestionOutput implements IQuestionOutput {
    message: string | undefined;

    constructor(data?: IQuestionOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuestionOutput {
        data = typeof data === 'object' ? data : {};
        let result = new QuestionOutput();
        result.init(data);
        return result;
    }
